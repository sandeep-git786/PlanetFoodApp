...
public class EditEmpFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jcJob, 0, 100, Short.MAX_VALUE))
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/planetfoodapp/gui/content.png"))); // NOI18N
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(empId.isEmpty())
        {
          JOptionPane.showMessageDialog(null,"please input empid","invalid input!",JOptionPane.ERROR_MESSAGE);
          return;  
        }
        try
        {
            
            ResultSet rs=EmployeeDao.SearchEmployeeDetail(empId);
            if(rs.next())
            {
            txtEmpName.setText(rs.getString("ename"));
            jcJob.setSelectedItem(rs.getString("job"));
            txtSalary.setText(String.valueOf(rs.getDouble("sal")));  
            }
            else
            {    
        ...
        {
          JOptionPane.showMessageDialog(null,"DB error!","invalid input!",JOptionPane.ERROR_MESSAGE);
          ex.printStackTrace();  
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try
        {
            ...
            boolean status=EmployeeDao.UpdateEmployee(e);
            if(status)
            {
